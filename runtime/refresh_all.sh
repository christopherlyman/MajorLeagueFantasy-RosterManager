...
YAHOO_SLEEP_SECONDS=${YAHOO_PLAYER_POOL_SLEEP_SECONDS:-2} \
YAHOO_REQUEST_MAX_ATTEMPTS=${YAHOO_REQUEST_MAX_ATTEMPTS:-4} \
YAHOO_REQUEST_BACKOFF_SECONDS=${YAHOO_REQUEST_BACKOFF_SECONDS:-20} \
POSTGRES_DSN=\${POSTGRES_DSN:-\$MLF_POSTGRES_DSN} \
