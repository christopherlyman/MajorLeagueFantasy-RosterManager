...
from scripts.yahoo.dated_roster import fetch_yahoo_dated_roster_slots
...
def main() -> None:
    ...
    hitter_rows = fetch_yahoo_dated_roster_slots(team_key, usage_date, HITTER_SLOTS)
    pitcher_rows = fetch_yahoo_dated_roster_slots(team_key, usage_date, PITCHER_SLOTS)
